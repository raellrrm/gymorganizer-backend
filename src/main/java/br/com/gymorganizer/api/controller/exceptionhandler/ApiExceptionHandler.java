...
public class ApiExceptionHandler extends ResponseEntityExceptionHandler {
    ...
    protected ResponseEntity<Object> handleMethodArgumentNotValid(
        ...
        String detail = "Um ou mais campos foram preenchidos incorretamente. Preencha corretamente os campos e " +
                "tente novamente";

        BindingResult bindingResult = ex.getBindingResult();

        List<Problem.Field> probleFields = bindingResult.getFieldErrors()
                .stream()
                .map(fieldError -> {
        ...
        Problem problem = createProblemBuilder(type, detail, (HttpStatus) status, LocalDateTime.now())
                .fields(probleFields)
                .build();
